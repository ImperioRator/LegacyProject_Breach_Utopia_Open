...
ENT.AnimationFrames = {
	{Vector(-9122.8837890625, -11800.090820313, 6209.03125), Angle(0, -90, 0)},
	{Vector(-9122.318359375, -11252.5390625, 6201.03125), Angle(0, -90, 0)},
...
function ENT:Initialize()
	...
	for k,v in pairs(ents.FindInSphere(Vector(-9123.1728515625, -11528.119140625, 6208.58984375),100)) do 
