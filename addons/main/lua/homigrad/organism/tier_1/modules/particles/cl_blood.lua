...
bloodparticles_hook[1] = function(anim_pos, mul)
	...
	for i = 1, #hg.bloodparticles1 do
		...
		-- ComputeLighting убраны, т.к. приводили к крашам вне BSP дерева (в скайбоксе)
		local light = light1 * 3
...
bloodparticles_hook[2] = function(mul)
	...
	for i = #hg.bloodparticles1, 1, -1 do
		...
		if result.HitSky then table_remove(hg.bloodparticles1, i) continue end -- ЗАЩИТА ОТ КРАША СКАЙБОКСА
