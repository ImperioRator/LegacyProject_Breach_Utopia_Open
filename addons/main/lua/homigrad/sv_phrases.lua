...
hook.Remove("Org Think", "ItHurtsfrfr",function(owner, org, timeValue)
...
hook.Remove("Org Think", "WhatsSoFunny",function(owner, org, timeValue)
...
hook.Remove("HarmDone", "killmazafaka", function(attacker, victim, amt)
...
hook.Remove("HarmDone", "MateDead", function(attacker, victim, amt)
	if !IsValid(victim) or !victim:IsPlayer() then return end
